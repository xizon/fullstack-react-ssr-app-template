 ...
 *
 * ## Project Name        :  Full-Stack React SSR Application Template
 * ## Project Description :  This repository is a full-stack sample web application based on React+TypeScript+Babel+Webpack+Jest (+Redux+Express) that creates a simple whole-website architecture with Server-Side Rendering (SSR).
 * ## Project URL         :  https://uiux.cc
 * ## Version             :  0.1.2
 * ## Based on            :  fullstack-react-ssr-app-template (https://github.com/xizon/fullstack-react-ssr-app-template#readme)
...
_ref) {
  ...
  var _ref2 = _ref,
    ...
    return "ConnectAdvanced(" + name + ")";
      ...
      connectOptions = objectWithoutPropertiesLoose_objectWithoutPropertiesLoose(_ref2, _excluded);
...
var styles = __webpack_require__(3060);
;// CONCATENATED MODULE: ./src/client/components/Buttons/index.tsx
...
var Buttons_excluded = ["bgColor", "btnName", "href"];
...
/* harmony default export */ const Home = (function (_ref) {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    className: "content"
  }, /*#__PURE__*/react.createElement("p", null, "This repository is a full-stack sample web application based on ", /*#__PURE__*/react.createElement("strong", null, "React+TypeScript+Babel+Webpack+Jest (+Redux+Express)"), " that creates a simple whole-website architecture with ", /*#__PURE__*/react.createElement("strong", {
    style: {
      color: 'red'
    }
  }, "Server-Side Rendering (SSR)"), ", and provides the foundational services, components, and plumbing needed to get a basic web application up and running. "), /*#__PURE__*/react.createElement("h3", null, "Component Import:"), /*#__PURE__*/react.createElement(Button, {
    bgColor: "",
    btnName: "",
    href: "#"
...
var actionCreators = function actionCreators() {
  ...
  return /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(dispatchFunction) {
      var res, action;
...
;// CONCATENATED MODULE: ./src/client/views/_pages/Posts/index.js
...
/* harmony default export */ const _pages_Posts = (connect(Posts_mapStateToProps, Posts_mapDispatchToProps)(Posts));
      ...
      return regenerator_default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios_default().get("https://restcountries.com/v2/name/".concat(id));
...
/* harmony default export */ const Posts_PostDetail = (connect(PostDetail_mapStateToProps, PostDetail_mapDispatchToProps)(PostDetail));
...
function HookContent() {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("h3", null, "Nested Routes Page"), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(NavLink, {
    to: "".concat(url, "/topic-one"),
    activeClassName: "is-active"
  }, "> click here to display Topic One")), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(NavLink, {
    to: "".concat(url, "/topic-two"),
    activeClassName: "is-active"
  }, "> click here to display Topic Two")), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(NavLink, {
...
function demoListReducer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? demoListReducer_ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : demoListReducer_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }

//initialize state
var initialState = {
  items: null
};
/* harmony default export */ const demoListReducer = (function () {
...
function demoListDetailReducer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }

function demoListDetailReducer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? demoListDetailReducer_ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : demoListDetailReducer_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }

//initialize state
var demoListDetailReducer_initialState = {
  detail: null
};
/* harmony default export */ const demoListDetailReducer = (function () {
  ...
  switch (action.type) {
    case 'RECEIVE_DEMO_LISTDETAIL':
      {
        return demoListDetailReducer_objectSpread(demoListDetailReducer_objectSpread({}, state), {}, {
...
var store = createStore(reducers, state, applyMiddleware(es)); //

react_dom.hydrate( /*#__PURE__*/react.createElement(components_Provider, {
  store: store
}, /*#__PURE__*/react.createElement(router, null)), document.querySelector('#app'));
})();
